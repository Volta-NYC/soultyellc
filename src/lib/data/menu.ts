...
export const menu: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: "Oxtail Plates", price: "$28" },
      { name: "Salmon w/ Garlic Butter", price: "$20", featured: true },
      { name: "Sweet n' Sour Salmon", price: "$20" },
      { name: "Turkey Wings", price: "$20" },
      { name: "Hot Honey Catfish", price: "$18" },
      { name: "Pan Seared Salmon", price: "$20" },
      { name: "3 PC Fried Whiting Meal", price: "$18", note: "Made to order" },
